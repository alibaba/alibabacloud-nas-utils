...
def test_state_files(tmpdir):
    ...
    alinas_config = 'cpfs-deadbeef.127.0.0.1.cpfs.aliyuncs.com'
    ...
    assert 'cpfs-deadbeef.127.0.0.1.cpfs.aliyuncs.com' in state_files
    assert state_files['cpfs-deadbeef.127.0.0.1.cpfs.aliyuncs.com'] == alinas_config
