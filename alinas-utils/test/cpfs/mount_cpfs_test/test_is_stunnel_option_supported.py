...
def test_supported_option(capsys):
    enabled = mount_cpfs.is_stunnel_option_supported(STUNNEL_OUTPUT_WITH_OPTION, STUNNEL_OPTION)

    assert enabled


def test_unsupported_option():
    enabled = mount_cpfs.is_stunnel_option_supported(STUNNEL_OUTPUT_WITHOUT_OPTION, STUNNEL_OPTION)
